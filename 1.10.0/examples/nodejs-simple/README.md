...
```
$ docker run --network=host registry-bj.capitalonline.net/agones-images/nodejs-simple-server:0.5
```
Or directly via npm:
```
$ npm start
...
```
$ make args="--help" run
$ docker run --network=host registry-bj.capitalonline.net/agones-images/nodejs-simple-server:0.5 --help
$ npm start -- --help
```
...
$ docker run --network=host registry-bj.capitalonline.net/agones-images/nodejs-simple-server:0.5 --timeout=120
...
$ docker run --network=host registry-bj.capitalonline.net/agones-images/nodejs-simple-server:0.5 --timeout=0
$ npm start -- --timeout=0
```
...
```
$ make args="--alpha" run
$ docker run --network=host registry-bj.capitalonline.net/agones-images/nodejs-simple-server:0.5 --alpha
$ npm start -- --alpha
```
